      ...
      <div class="analysis-preview surface">
        ...
        <div class="preview-grid">
          <div class="preview-item">
            ...
            <div>
              <div class="preview-item__title">归属体系</div>
              <div class="preview-item__desc">科目、年级、章节、知识点</div>
            </div>
          </div>
          <div class="preview-item">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="preview-item__icon">
            ...
            <div>
              <div class="preview-item__title">难度 + 参考解析</div>
              <div class="preview-item__desc">基础 / 进阶 / 挑战 + 完整解题过程</div>
            </div>
          </div>
          <div class="preview-item">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="preview-item__icon">
