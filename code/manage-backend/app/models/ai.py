...
class AiChatSession(Base):
    ...
    parent_training_session_id: Mapped[str | None] = mapped_column(
    ...
    silence_triggered_at: Mapped[datetime | None] = mapped_column(
...
class AiStudentStrategyProfile(Base):
    ...
    effectiveness_score: Mapped[Decimal] = mapped_column(
...
class StudentAiPromptSummary(Base, TimestampMixin):
    ...
    learning_summary_updated_at: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
    ...
    personal_insight_updated_at: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
